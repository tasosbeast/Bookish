...
export function ReviewForm({ personal, onSaved }) {
  ...
  async function remove() {
    ...
    try {
      ...
      setText('');
      onSaved('Your review has been deleted. Your rating remains in My Books.');
    } catch (error) { setError(error); } finally { setBusy(null); }
  }
